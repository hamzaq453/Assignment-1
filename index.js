...
function printCarstatement(carBrands) {
...
const unavailableIndexx = 1;
const newguest = "Nelson";
guests[unavailableIndexx] = newguest;
function inviteguests1(guests) {
    guests.forEach((person) => {
        console.log(`Dear ${person} you are invited to dinner`);
    });
}
...
function inviteguests3(guests3) {
    guests.forEach((person) => {
        console.log(`Dear ${person} you are invited to dinner`);
    });
}
...
const current_users = ['admin', 'eric', 'julia', 'john', 'susan'];
// List of new usernames
const new_users = ['John', 'susan', 'mike', 'alice', 'Julia'];
...
const favorite_pizzas = ['Pepperoni', 'Margherita', 'Fajitaa'];
...
const magician_names1 = ['David Copperfield', 'Harry Houdini', 'Penn Jillette', 'Teller'];
